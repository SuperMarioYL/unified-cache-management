...
- CUDA uses the official PyTorch per-architecture builders used by the vLLM v0.21.0 build system. amd64 is `docker.io/pytorch/manylinux2_28-builder:cuda13.0` index `sha256:83d73c3fd2782b23de8a1873820236273d8a6db911aea15c017766c9a40e723c`, linux/amd64 member `sha256:746796491b3a375ee352c60ad1265c599bb1aa1762a0de46927e0f4139832918`, config `sha256:0c34d69ef0b04dbf678564146d299bdad59f7d2b8e166b4f59df5e2fce3a34f2`. arm64 is the separate repository `docker.io/pytorch/manylinuxaarch64-builder:cuda13.0` index `sha256:ab80e6e1e9d3170faae3590bfcdc7097d209306998073e8b696a1c1456853dfa`, linux/arm64 member `sha256:48eb3eb1b3ab79fb30e49d3692a60dc15f05a3d1c4ba328400af5f06b2e6949c`, config `sha256:be379de193a3c28da06ad14d2681842350986c46fbcbebf8d0d47ef3c9bd7f7e`.
- CUDA builder configuration must therefore model per-architecture repositories and indexes rather than pretending this pair is one multiarch image. The preflight requires `/opt/python/cp312-cp312`, native cp312 SOABI, GCC toolset 13, CUDA 13.0.2 with `nvcc`, `g++`, `make`, `git`, CMake, and CUDA headers; it also asserts that Mooncake, ds3fs, sparse and MindIE build inputs are absent.
