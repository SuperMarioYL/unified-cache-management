...
![pd-system-overview](https://cdn.jsdelivr.net/gh/SuperMarioYL/ImageHostingService@master/resources/blogs/pd-system-overview.png)
...
![direction-a-connectors](https://cdn.jsdelivr.net/gh/SuperMarioYL/ImageHostingService@master/resources/blogs/direction-a-connectors.png)
...
D DRAM 暂存、共享 Transfer Engine、注册复用和层级内存回收继续作为各条路径的传输与内存优化。它们各自的容量、同步和生命周期处理保留在 Connector 实现方案中；逐层流水本身不等于已经减少了 KV 池的分配量。
...
![direction-b-routing](https://cdn.jsdelivr.net/gh/SuperMarioYL/ImageHostingService@master/resources/blogs/direction-b-routing.png)
...
![direction-c-hot-read](https://cdn.jsdelivr.net/gh/SuperMarioYL/ImageHostingService@master/resources/blogs/direction-c-hot-read.png)
...
![store-d-p-layerwise](https://cdn.jsdelivr.net/gh/SuperMarioYL/ImageHostingService@master/resources/blogs/store-d-p-layerwise.png)
...
![direction-e-store-and-prefill](https://cdn.jsdelivr.net/gh/SuperMarioYL/ImageHostingService@master/resources/blogs/direction-e-store-and-prefill.png)
...
![direction-f-compute-placement](https://cdn.jsdelivr.net/gh/SuperMarioYL/ImageHostingService@master/resources/blogs/direction-f-compute-placement.png)
