...
Build UCM in the matching [Ascend environment](../../../developer-guide/build_from_source.md#vllm-ascend-ascend-platform)
...
Use the [vLLM-Ascend quickstart](../../quick_start/quickstart_vllm_ascend.md) to
...
See [Metrics](../../observability/metrics.md) for load-hit, load-miss, backend,
and byte counters, and [Health metrics](../../observability/health-metrics.md)
...
hits and filesystem hits separately using the
[benchmark guide](../../../benchmark/index.md); no speedup is assumed by enabling
this pipeline.
