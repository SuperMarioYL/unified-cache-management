...
[build from source](../../../developer-guide/build_from_source.md) for the target
...
Supply this file using the [vLLM quickstart](../../quick_start/quickstart_vllm.md)
or [vLLM-Ascend quickstart](../../quick_start/quickstart_vllm_ascend.md). Verify
...
[external-cache procedure](../../quick_start/quickstart_vllm.md#verify-the-service-and-external-cache)
