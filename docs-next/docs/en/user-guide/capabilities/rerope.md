...
!!! note "Migrated reference and validation scope"
    The original example targets vLLM 0.9.2 or 0.11.0 with its version-specific patch.
    This guide preserves the [original repository reference](https://github.com/ModelEngine-Group/unified-cache-management/blob/a336d69bc03a550d44bee3df9da7664e9edfe3a7/docs/source/user-guide/rerope/rerope.md).
...
![ReRoPE Results](../../../assets/images/rerope_performace.png)
